...
namespace Ink.Runtime
{
    ...
    public class StoryState
    {
        ...
        /// </summary>
        public IDictionary<string, object> jsonToken
        {
            get {
            ...
            set {
                ...
                callStack.SetJsonToken ((IDictionary < string, object > )jObject ["callstackThreads"], story);
                variablesState.jsonToken = (IDictionary < string, object> )jObject["variablesState"];

                evaluationStack = Json.JArrayToRuntimeObjList ((ICollection)jObject ["evalStack"]);

                _outputStream = Json.JArrayToRuntimeObjList ((ICollection)jObject ["outputStream"]);
                OutputStreamDirty();

                _currentChoices = Json.JArrayToRuntimeObjList<Choice>((ICollection)jObject ["currentChoices"]);
                ...
                visitCounts = Json.JObjectToIntDictionary ((IDictionary<string, object>)jObject ["visitCounts"]);
                turnIndices = Json.JObjectToIntDictionary ((IDictionary<string, object>)jObject ["turnIndices"]);
                ...
                var jChoiceThreads = (IDictionary<string, object>)jChoiceThreadsObj;
                ...
                foreach (var c in _currentChoices) {
                    ...
                    if( foundActiveThread != null ) {
                        ...
                        var jSavedChoiceThread = (IDictionary <string, object>) jChoiceThreads[c.originalThreadIndex.ToString()];
